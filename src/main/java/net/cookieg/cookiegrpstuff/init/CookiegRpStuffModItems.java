...
import net.cookieg.cookiegrpstuff.item.BombVerstActivatorItem;
...
public class CookiegRpStuffModItems {
	...
	public static final RegistryObject<Item> BOMB_VERST_ACTIVATOR = REGISTRY.register("bomb_verst_activator", () -> new BombVerstActivatorItem());
