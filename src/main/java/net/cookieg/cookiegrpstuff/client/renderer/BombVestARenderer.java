...
public class BombVestARenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("cookieg_rp_stuff", "textures/entities/bomb_vest_a.png");
	private final Modelbomb_vest_A model;

	public BombVestARenderer() {
		this.model = new Modelbomb_vest_A(Minecraft.getInstance().getEntityModels().bakeLayer(CookiegRpStuffModLayerDefinitions.BOMB_VEST_A));
	}
